...
// captionsData - заголовок із заданого атрибуту (з alt)
//aptionPosition - позиція відображення заголовка (тобто, положення підпису. Варіанти: зверху, знизу або зовні )
// captionDelay - додає затримку перед показом підпису (у мс)
